...
// #include "DQM/HcalMonitorClient/interface/HcalNoiseClient.h"
...
HcalMonitorClient::HcalMonitorClient(const edm::ParameterSet& ps)
{
  ...
  // if (find(enabledClients_.begin(), enabledClients_.end(),"HcalNoiseMonitor")!=enabledClients_.end())
  //   clients_.push_back(new HcalNoiseClient((std::string)"HcalNoiseMonitor",ps));
